...
# Initialize CarLicensePlateDetector, assuming the model file is in 'models/best.pt'
...
def upload_file(request):
    if request.method == 'POST':
        ...
        if not file:
            return JsonResponse({"error": "No file provided or filename is empty"}, status=400)
